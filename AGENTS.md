...
- **For detailed testing workflow and conventions, use the workspace skill at `.agents/testing-best-practices/SKILL.md`** when writing, debugging, or reviewing tests
...
- **Detailed Workflow:** Use `.agents/testing-best-practices/SKILL.md` for framework-specific patterns, `TestHelper` usage, query conventions, and verification requirements.
